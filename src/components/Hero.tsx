...
export function Hero() {
  return (
    ...
    >
      {/* Animated Background Energy Waves - Disabled on Mobile for Performance */}
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="hidden md:block absolute top-1/4 left-1/4 w-[500px] h-[500px] md:w-[600px] md:h-[600px] lg:w-[600px] lg:h-[600px] bg-[#c41e3a] rounded-full blur-[150px] md:blur-[200px]"
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
          ...
          className="hidden md:block absolute bottom-1/4 right-1/4 w-[600px] h-[600px] md:w-[600px] md:h-[600px] lg:w-[700px] lg:h-[700px] bg-[#d4af37] rounded-full blur-[180px] md:blur-[220px]"
        />
      </div>
      ...
      {/* Large Logo - Central Background Element - Simplified on Mobile */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div className="relative w-full h-full flex items-center justify-center">
          {/* Animated Pulsing Glow Effect - Desktop Only */}
          <motion.div
            animate={{
              scale: [1, 1.1, 1],
              opacity: [0.2, 0.4, 0.2],
            ...
            className="hidden md:block absolute inset-0 bg-[#d4af37] blur-[80px] md:blur-[100px] rounded-full"
          />
          <img
            src={logo}
            alt="FCC Logo"
            ...
            style={{ transform: 'rotate(-12deg)', willChange: 'auto' }}
          />
        </div>
      </motion.div>

      {/* Animated Energy Streaks - Fewer on Mobile */}
      {[...Array(4)].map((_, i) => (
        <motion.div
          key={i}
          animate={{
          ...
          className="hidden sm:block absolute h-[1px] sm:h-[2px] w-1/3 sm:w-1/4 bg-gradient-to-r from-transparent via-[#d4af37] to-transparent"
          style={{
            top: `${25 + i * 20}%`,
            rotate: `${-45 + i * 20}deg`,
          }}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-20">
        <div className="text-center">
          ...
          >
            <Zap className="h-4 w-4 sm:h-5 sm:w-5 text-[#ffd700] md:animate-pulse" />
          ...
          >
            <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-[1.1] sm:leading-tight">
              ...
              <span className="relative block mt-1 sm:mt-2 px-2">
                <span className="hidden md:block absolute inset-0 text-[#d4af37] blur-[2px] opacity-80">STRONGEST MAN</span>
          ...
          >
            <div className="group relative px-4 py-2 sm:px-6 sm:py-3 bg-black/80 md:bg-black/70 md:backdrop-blur-md border-2 border-[#ffd700] rounded-lg shadow-lg md:shadow-[0_0_30px_rgba(255,215,0,0.4)]">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <span className="text-base sm:text-lg md:text-xl font-black text-white">5 Workouts</span>
              </div>
            </div>
            <div className="group relative px-4 py-2 sm:px-6 sm:py-3 bg-black/80 md:bg-black/70 md:backdrop-blur-md border-2 border-[#c41e3a] rounded-lg shadow-lg md:shadow-[0_0_30px_rgba(196,30,58,0.4)]">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <span className="text-base sm:text-lg md:text-xl font-black text-white">₹1 Lakh Prize</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative w-full sm:w-auto px-6 py-4 sm:px-10 sm:py-5 bg-gradient-to-r from-[#c41e3a] via-[#d4af37] to-[#c41e3a] text-base sm:text-xl md:text-2xl font-black text-white rounded-lg shadow-lg md:shadow-[0_0_60px_rgba(196,30,58,0.6)] transition-all border-2 border-white/20 overflow-hidden text-center"
            >
            ...
            <motion.a
              href="#strongest-man"
              whileTap={{ scale: 0.98 }}
              className="w-full sm:w-auto px-6 py-4 sm:px-8 sm:py-5 bg-black/90 md:bg-black/80 md:backdrop-blur-md border-2 border-[#ffd700] text-base sm:text-lg md:text-xl font-bold text-white rounded-lg md:hover:bg-[#ffd700]/10 transition-all shadow-lg md:shadow-[0_0_20px_rgba(255,215,0,0.3)] text-center"
            >
              Explore Events
          ...
          {/* Scroll Indicator - Static on Mobile, Animated on Desktop */}
          <div className="hidden xs:block absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2">
            ...
            >
              <ChevronRight className="w-6 h-6 sm:w-8 sm:h-8 text-[#ffd700] rotate-90 opacity-80" />
            </motion.div>
            <ChevronRight className="md:hidden w-6 h-6 text-[#ffd700] rotate-90 opacity-60" />
          </div>
        </div>
      </div>
